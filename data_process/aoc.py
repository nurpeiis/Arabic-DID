...
<<<<<<< HEAD
dp = DataProcess('../aoc/', 'mechanical_turk_annotators', 'news_comments',
=======
...
>>>>>>> 39c40a32abb419c3292435fd3a80777e4d1b42d4
...
<<<<<<< HEAD
        '../AOC-dialectal-annotations/dialect_alghad-segs.txt.norm', '', '', '', 'levant', header=None))

    # Specify a directory to unprocessed dataset which stores AOC-dialectal-annotations.
    dp.save_file('dialect_youm7-segs.tsv', dp.preprocess(
        '../AOC-dialectal-annotations/dialect_youm7-segs.txt.norm', '', '', 'eg', 'nile_basin', header=None))

    # Specify a directory to unprocessed dataset which stores AOC-dialectal-annotations.
    dp.save_file('dialect_alriyadh-segs.tsv', dp.preprocess(
        '../AOC-dialectal-annotations/dialect_alriyadh-segs.txt.norm', '', '', '', 'gulf', header=None))

    # Specify a directory to unprocessed dataset which stores AOC-dialectal-annotations.
    dp.save_file('MSA_alghad-segs.tsv', dp.preprocess(
        '../AOC-dialectal-annotations/MSA_alghad-segs.txt.norm', 'msa', 'msa', 'msa', 'msa', header=None))

    # Specify a directory to unprocessed dataset which stores AOC-dialectal-annotations.
    dp.save_file('MSA_youm7-segs.tsv', dp.preprocess('../AOC-dialectal-annotations/MSA_youm7-segs.txt.norm',
=======
...
<<<<<<< HEAD
        '../AOC-dialectal-annotations/MSA_alriyadh-segs.txt.norm', 'msa', 'msa', 'msa', 'msa', header=None))
=======
